...
class ClassificationTemplateServiceImpl(
	...
	override suspend fun modifyClassificationTemplate(classificationTemplate: ClassificationTemplate): ClassificationTemplate = classificationTemplateLogic.modifyEntity(classificationTemplate)
